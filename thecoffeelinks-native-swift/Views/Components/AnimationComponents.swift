...
struct ConfettiView: View {
    ...
    let colors: [Color] = [.sunRay, .forestCanopy, .red, .orange, .blue, .green]
...
struct SuccessCheckmark: View {
    ...
    var body: some View {
        ZStack {
            // Circle
            Circle()
                .stroke(Color.forestCanopy.opacity(0.2), lineWidth: 4)
                .frame(width: 80, height: 80)
            
            // Animated circle
            Circle()
                .trim(from: 0, to: isAnimating ? 1 : 0)
                .stroke(Color.forestCanopy, style: StrokeStyle(lineWidth: 4, lineCap: .round))
                .frame(width: 80, height: 80)
            ...
            .trim(from: 0, to: isAnimating ? 1 : 0)
            .stroke(Color.forestCanopy, style: StrokeStyle(lineWidth: 4, lineCap: .round, lineJoin: .round))
